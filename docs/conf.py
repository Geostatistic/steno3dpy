# -*- coding: utf-8 -*-
#
# steno3d documentation build configuration file, created by
...
# pixels large.
html_favicon = 'images/steno3d_icon.ico'
...
man_pages = [
    (master_doc, 'steno3d', u'steno3d Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'steno3d', u'steno3d Documentation',
     author, 'steno3d', 'One line description of project.',
     'Miscellaneous'),
]
...
linkcheck_ignore = ['http://mybinder.org/repo/3ptscience/steno3d-notebooks',
